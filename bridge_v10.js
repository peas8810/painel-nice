(()=>{
  if(window.__NICE_BRIDGE_ACTIVE)return;
  window.__NICE_BRIDGE_ACTIVE=true;
  ...
  const boot=()=>{
    try{
      ...
      s.src='dashboard_v10.js?v=10';
      s.onload=()=>console.info('NICE: dashboard v10 carregado');
      s.onerror=()=>show('Não foi possível carregar dashboard_v10.js.');
