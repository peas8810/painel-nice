...
function niceCertCustomGeneratePdf_(link,cert){
  ...
  niceCertLogo_(slide,36,28);niceCertText_(slide,'NICE · CERTIFICADO',100,31,500,22,12,gray,true,'START');niceCertText_(slide,'CERTIFICADO',75,66,570,38,25,navy,true,'CENTER');niceCertText_(slide,'CERTIFICATE',75,103,570,20,12,blue,false,'CENTER');
